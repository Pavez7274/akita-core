...
exports.Lexer = exports.LexerAkitaFunction = exports.LexerError = void 0;
...
var Lexer = (function () {
    ...
    Lexer.prototype.resolve = function (input, _a) {
        ...
        for (var _i = 0, _b = Array.from(input.matchAll(Lexer.CONDITION_EXPRESSION), function (match) { return [match[0], match[1], match[4], match[5]]; }); _i < _b.length; _i++) {
            ...
            var type = get_type(symbol);
            input = input.replace(match, type === "setter"
                ? "akita-core:set".concat(opener + left + argument + right + closer)
                : "akita-core:condition".concat(opener + type + argument + left + argument + right + closer));
        }
