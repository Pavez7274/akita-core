...
var Interpreter = (function () {
    ...
    Interpreter.prototype.solve = function (data, debug) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _c, input, functions_array, _loop_1, this_1, _i, functions_array_1, af;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = this.lexer.main((0, lodash_1.isObject)(debug) ? debug.lexer : debug), input = _c.input, functions_array = _c.functions_array;
                        ...
                        _loop_1 = function (af) {
                            ...
                            return tslib_1.__generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        finded = (0, lodash_1.values)(Interpreter.functions).find(function (f) { return f.name_in === af.name || f.name === af.name; });
                                    ...
                                    case 1:
                                        _e.trys.push([1, 3, , 7]);
                                        return [4, finded.solve.apply(this_1, [af, data])];
                                    case 2:
                                        data = _e.sent();
                                        return [3, 7];
                                    case 3:
                        ...
                        _d.label = 1;
                    case 1:
                        if (!(_i < functions_array_1.length)) return [3, 4];
