            ...
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        _e = this.lexer.main((0, lodash_1.isObject)(debug) ? debug.lexer : debug), input = _e.input, functions_array = _e.functions_array;
